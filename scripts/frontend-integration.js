 ...
 * This file demonstrates how to integrate Echosway with a web frontend
 */

// For React/Vue/Angular applications
export class EchoswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EchoswayClient(provider, contractAddress);
